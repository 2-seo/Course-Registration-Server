...
public class EditAnswerFrame extends JFrame {
	...
	public EditAnswerFrame(ActionListener buttonHandler) {
		...
		JPanel line4 = new JPanel();
			...
			btnAnswer.setActionCommand("updateAnswer");
			btnClose.setActionCommand("closeEditAnswerFrame");
	...
	public void setInquireResultInfo(MInquireResult mInquireResult) {
	...
	public void updateAnswer() {
		...
		String message = "문의사항 답변을 수정하시겠습니까?";
		...
		if (reply == JOptionPane.YES_OPTION) {
			...
			if(!this.txtAnswerContents.getText().equals("")) {
				...
				cInquire.updateAnswer(inquireNo, answerContents);
	...
	public void closeEditAnswerFrame() {
		this.dispose();
	}
